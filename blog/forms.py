...
class BlogUserCreationForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        user = super(BlogUserCreationForm, self).save(commit=False)
...
class BlogPasswordRestForm(forms.Form):
    ...
    def clean(self):
        ...
        if username and email:
            try:
                self.user = BlogUser.objects.get(username=username,email=email,is_active=True)
            except BlogUser.DoesNotExist:
                raise forms.ValidationError(
