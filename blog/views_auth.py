...
from blog.forms import BlogUserCreationForm,BlogPasswordRestForm
...
class UserControl(View):
    ...
    def forgetpassword(self,request):
        ...
        form = BlogPasswordRestForm(request.POST)
    ...
    def resetpassword(self,request):
        ...
        try:
            ...
            user = BlogUser._default_manager.get(pk=uid)
    ...
    def changetx(self, request):
        ...
        if not data:
            ...
            return HttpResponse(u"请选取头像大小", status=500)
        ...
        try:
	        # 上传头像到七牛
            from mini_blog.settings import qiniu_access_key,qiniu_secret_key,qiniu_bucket_name
            import qiniu
